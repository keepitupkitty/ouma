...
# Get UnicodeData.txt and EastAsianWidth.txt by using the following links.
#
...
print('--- towlower()')
t = list(to_trans_extents(TOLOWER.items()))
print_type_table(t)
print('---')
print_delta_table(t)

print('--- towupper()')
t = list(to_trans_extents(TOUPPER.items()))
print_type_table(t)
print('---')
print_delta_table(t)

print('--- wcwidth()')
print_width_table(to_width_extents(WIDTH.items()))
